...
function App() {
  ...
  const [activeTab, setActiveTab] = useState('store'); // 'store', 'daylog', 'orders', 'materials', 'packing', 'summary' or 'setup'
        ...
        {configError ? (
          ...
          <div>
            ...
            {activeTab === 'store' ? (
              ...
              <div className="max-w-3xl mx-auto">
                <DayLog authHelper={authHelper} />
              </div>
            ) : activeTab === 'orders' ? (
              <div className="max-w-3xl mx-auto">
                <StoreOrders authHelper={authHelper} />
              </div>
            ) : activeTab === 'materials' ? (
              <div className="max-w-3xl mx-auto">
