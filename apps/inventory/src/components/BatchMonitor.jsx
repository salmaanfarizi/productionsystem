  ...
  const loadBatches = async () => {
    ...
    try {
      ...
      const filtered = parsed
        ...
        .sort((a, b) => new Date(b['Production Date']) - new Date(a['Production Date'])); // Newest first
                ...
                <div className="flex justify-between items-start mb-2">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {batch['Product Type']} - {batch['Seed Variety']} - {batch['Size Range']}
                      {batch['Variant/Region'] && ` (${batch['Variant/Region']})`}
                    </p>
