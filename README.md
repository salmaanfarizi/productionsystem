...
### Production URLs
- 🏭 **Production**: https://production.abusalim.sa
...
- **Features**:
  ...
  - Track physical stock, transfers, and system stock
  - Stock outwards categories (salesman transfers, warehouse, damaged, samples, returns)
